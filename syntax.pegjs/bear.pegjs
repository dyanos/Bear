...
UsingStatement 
  = UsingKeyword __ name:NamespaceName aliasName:(__ "=" __ AliasName)? {
      if (aliasName == null) {
        console.log("Alias Namespace : " + name + " = " + aliasName[3]);
      }
      else {
        console.log("Load Namespace : " + name);
      }
    }
...
FunctionDeclaration
  = DefKeyword __ name:Identifier __ "(" __ Arguments __ ")" returnVal:(":" __ ReturnType)? __ DefBody {
...
DefBody 
  = "=" __ Expression
  / "{" ( FunctionDeclaration / VariableDeclaration / ValueDeclaration / Expressions )* "}" 
...
ForStatement
  = ForKeyword ForConditionStatement ForBody

// 아직 미정
ForConditionStatement 
  = name:Identifier __ "<=" __ ForSource
